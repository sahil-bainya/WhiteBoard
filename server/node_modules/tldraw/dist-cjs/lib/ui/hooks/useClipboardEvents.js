...
async function handleClipboardThings(editor, things, point, clipboardPasteSource) {
  ...
  if (files.length) {
    ...
    return await (0, import_pasteFiles.pasteFiles)(editor, fileBlobs, point, void 0, clipboardPasteSource);
  }
...
const handleNativeOrMenuCopy = async (editor, context = { operation: "copy", source: "menu" }) => {
