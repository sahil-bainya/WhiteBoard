...
const sizeCache = (0, import_editor.createComputedCache)(
  ...
  (editor, shape) => {
    ...
    const dv = (0, import_getDisplayValues.getDisplayValues)(util, shape);
...
class TextShapeUtil extends import_editor.ShapeUtil {
  ...
  options = {
    ...
    getDefaultDisplayValues(_editor, shape, theme, colorMode) {
      ...
      return {
        color: (0, import_editor.getColorValue)(theme.colors[colorMode], color, "solid"),
        fontFamily: (0, import_default_shape_constants.getFontFamily)(theme, font),
        fontSize: theme.fontSize * import_default_shape_constants.FONT_SIZES[size],
        lineHeight: theme.lineHeight,
        fontWeight: import_default_shape_constants.TEXT_PROPS.fontWeight,
        fontStyle: import_default_shape_constants.TEXT_PROPS.fontStyle,
        fontVariant: import_default_shape_constants.TEXT_PROPS.fontVariant
      };
    },
  ...
  onBeforeUpdate(prev, next) {
    ...
    const dv = (0, import_getDisplayValues.getDisplayValues)(this, next);
...
function getTextSize(editor, props, dv) {
