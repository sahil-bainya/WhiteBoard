...
class DrawShapeUtil extends import_editor.ShapeUtil {
  ...
  getGeometry(shape) {
    ...
    const sw = ((0, import_getDisplayValues.getDisplayValues)(this, shape).strokeWidth + 1) * shape.props.scale;
  ...
  getIndicatorPath(shape) {
    ...
    let sw = ((0, import_getDisplayValues.getDisplayValues)(this, shape).strokeWidth + 1) * shape.props.scale;
  ...
  expandSelectionOutlinePx(shape) {
    ...
    return (0, import_getDisplayValues.getDisplayValues)(this, shape).strokeWidth * multiplier / 2 * shape.props.scale;
  }
...
function DrawShapeSvg({
  ...
  if (!forceSolid && shape.props.dash === "draw") {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      shape.props.isClosed && shape.props.fill !== "none" && allPointsFromSegments.length > 1 && (shape.props.fill === "pattern" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: (0, import_svgInk.svgInk)(allPointsFromSegments, options), strokeLinecap: "round", fill: strokeColor })
    ] });
  }
  const strokePoints = (0, import_getStrokePoints.getStrokePoints)(allPointsFromSegments, options);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { fill: fillColor, d: solidStrokePath }),
    shape.props.dash !== "none" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "path",
      {
        d: solidStrokePath,
        strokeLinecap: "round",
