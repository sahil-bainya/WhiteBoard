...
class HighlightShapeUtil extends import_editor.ShapeUtil {
  ...
  options = {
    ...
    getDefaultDisplayValues(_editor, shape, theme, colorMode) {
      ...
      const useP3 = !import_editor.debugFlags.forceSrgb.get() && import_editor.tlenvReactive.get().supportsP3ColorSpace;
      const strokeColor = useP3 ? (0, import_editor.getColorValue)(colors, color, "highlightP3") : (0, import_editor.getColorValue)(colors, color, "highlightSrgb");
      return {
        strokeColor,
        strokeWidth: theme.fontSize * import_default_shape_constants.FONT_SIZES[size] * 1.12,
