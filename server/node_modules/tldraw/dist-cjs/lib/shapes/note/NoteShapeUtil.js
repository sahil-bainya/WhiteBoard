...
class NoteShapeUtil extends import_editor.ShapeUtil {
  ...
  getFontFaces(shape) {
    ...
    if (shape.props.textFirstEditedBy && !(0, import_richText.isEmptyRichText)(shape.props.richText)) {
  ...
  toSvg(shape, ctx) {
    ...
    const attributionFirstName = textFirstEditedBy && !(0, import_richText.isEmptyRichText)(shape.props.richText) ? this.editor.getAttributionDisplayName(textFirstEditedBy)?.split(" ")[0] : null;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      attributionName && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "text",
        {
          ...
          y: bounds.h - 6,
          textAnchor: "end",
          fontFamily: import_editor.DefaultFontFamilies["sans"],
          fontSize: 11,
          fill: dv.labelColor,
          opacity: 0.6,
